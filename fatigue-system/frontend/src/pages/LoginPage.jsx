...
function CameraStatusBanner({ status }) {
  ...
  const config = {
    ...
    granted: {
      ...
      color: "#00c864",
      icon: "✓",
      text: "Camera access granted. Gesture control active.",
    },
    denied: {
      ...
      color: "#ff7070",
      icon: "⚠",
      text: "Camera denied. Gesture control unavailable — mouse/keyboard only.",
    },
    error: {
      ...
      color: "#ffcc44",
      icon: "⚠",
      text: "Camera error. Continuing without gesture control.",
    },
  }[status];
    ...
    >
      <span
        style={{
          ...
          fontSize: 14,
          animation:
            status === "requesting" ? "spin 1s linear infinite" : "none",
...
function LoginPage() {
  ...
  const handleLogin = async () => {
    ...
    if (r.token) {
      ...
      await postAuth({ ...r.user, isGuest: false });
      ...
      {!isMobile && (
        <div
          style={{
            ...
            padding: "60px 56px",
            background:
              "radial-gradient(ellipse at 40% 40%, #1e0f40 0%, #0a0812 75%)",
            overflow: "hidden",
          }}
        >
          {/* Grid */}
          ...
          <div
            style={{
              ...
              borderRadius: "50%",
              background:
                "radial-gradient(circle, rgba(112,60,255,0.22) 0%, transparent 65%)",
              top: "-10%",
              left: "10%",
              pointerEvents: "none",
            }}
          ...
          <div
            style={{
              ...
              borderRadius: "50%",
              background:
                "radial-gradient(circle, rgba(60,200,255,0.1) 0%, transparent 70%)",
              bottom: "5%",
              right: "0%",
              pointerEvents: "none",
            }}
            ...
            >
              ...
              <span
                style={{
                  color: "transparent",
                  backgroundImage:
                    "linear-gradient(135deg, #a87cff 0%, #6025d6 100%)",
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
              ...
              >
                ...
                <div>
                  ...
                  >
                    Camera-based hands-free interaction
                  </div>
                </div>
              </FloatCard>
      ...
      >
        ...
        >
            ...
            {[
              ...
              <button
                ...
                style={{
                  ...
                  boxShadow:
                    mode === m ? "0 2px 14px rgba(112,60,255,0.45)" : "none",
                }}
              >
                {label}
              </button>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
            ...
            <CameraStatusBanner
              status={cameraStatus === "idle" ? null : cameraStatus}
            />
            ...
            <button
              ...
              style={{
                ...
                boxShadow:
                  loading || isLocked
                    ? "none"
                    : "0 6px 24px rgba(112,60,255,0.5)",
                display: "flex",
                alignItems: "center",
                justifyContent: "center",
                gap: 8,
